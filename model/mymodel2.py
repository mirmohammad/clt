...
class MyNet4(nn.Module):
    ...
    def __init__(self):
        ...
        # 320 x 180
        self.conv1_h = nn.Sequential(
            nn.Conv2d(3, 64, kernel_size=(9, 3), stride=(5, 1), padding=(3, 1), dilation=1, bias=False),
            nn.BatchNorm2d(64),
        )
        # 320 x 36
        self.conv1_w = nn.Sequential(
            nn.Conv2d(3, 64, kernel_size=(3, 9), stride=(1, 5), padding=(1, 3), dilation=1, bias=False),
            nn.BatchNorm2d(64),
        )
        # 64 x 180
        self.pool1_w = nn.MaxPool2d(kernel_size=(1, 5), stride=(1, 5), padding=0)
        # 64 x 36
        self.pool1_h = nn.MaxPool2d(kernel_size=(5, 1), stride=(5, 1), padding=0)
...
class MyNet5(nn.Module):
    ...
    def __init__(self):
        ...
        # 320 x 180
        self.pool1 = nn.MaxPool2d(kernel_size=(5, 5), stride=(5, 5), padding=0)
